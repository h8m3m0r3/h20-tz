...
import useCountingValue from "../../hooks/useCountingValue/useCountingValue";
...
const MainContent = () => {
  ...
  const { revenueFinal, expensesFinal, incomeFinal, debtFinal, totalFinal } =
    useCountingValue(selectedData);
  return (
    <main className="statistic">
      ...
      <section className="statistic__content">
        <figure>
          <section className="statistic__cards">
            <article
            ...
            >
              ...
              >
                {randomPercent[0] <= 0 ? (
                  <img
                    src={
                      selectedCategory === "Total" ? normalArrowDown : badArrow
                    }
                    alt="Стрелочка вниз"
            ...
            >
              ...
              >
                {randomPercent[1] <= 0 ? (
                  ...
                  <img
                    src={selectedCategory === "B2B" ? normalArrowUp : goodArrow}
                    alt="Стрелочка вверх"
                    style={{ width: "16px", marginRight: "5px" }}
                  />
                )}
            ...
            >
              ...
              >
                {randomPercent[2] <= 0 ? (
                  ...
                  <img
                    src={selectedCategory === "B2C" ? normalArrowUp : goodArrow}
                    alt="Стрелочка вверх"
                    style={{ width: "16px", marginRight: "5px" }}
                  />
                )}
          ...
          <section className="statistic__chartblock">
            <article className="statistic__chartheader">
            ...
            <article className="statistic__items">
        ...
        <aside className="statistic__aside">
          ...
          <ul className="aside__troubles">
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[0] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[0] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[1] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[1] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[2] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[2] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[3] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[3] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[4] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[4] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[5] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[5] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
              <div className="aside__trouble info">
                <p className="aside__trouble info__text">Ремонт оборудования</p>
                <p className="aside__trouble info__value">
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[6] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[6] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[7] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[7] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[8] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[8] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
            ...
            <li className="aside__trouble">
              <div
                className={`aside__trouble ${
                  randomTroubleValues[9] <= 10000
                    ? "greenCircle"
                    : randomTroubleValues[9] <= 50000
                    ? "yellowCircle"
                    : "redCircle"
                }`}
              />
